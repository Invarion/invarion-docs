...
**Note:** If the point you are currently drawing a line from is [snapped](/docs/rapid-plan/5.%20RapidPlan%20Basics/Control%20Point%20Snapping.md) to a geometric object or line, the distance plugged into to the Distance tool will automatically measure along the object or line selected if desired.
