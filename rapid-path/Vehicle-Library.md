...
All of these parameters can be modified when editing already placed vehicles. Read more about it in [Adding Vehicle to The Plan and Editing an Existing Vehicle](./Preparing-Swept-Path-Analysis.md).
