...
**To remove the last control point placed or continue placing control points where you left off:** While the object is selected, you'll find buttons for each of these controls in the [**Context Menu**](/rapidpath-online/rapidpath-online-basics/context-menu.md).
