...
To select multiple objects, simply **tap and drag** across the objects you wish to select, creating a [selection box](/docs/rapidpath-online/rapidpath-online-workspace/select-tool.md).

To access the [Context Menu](/docs/rapidpath-online/rapidpath-online-basics/context-menu.md), tap and hold on the selected object/s, then the menu will appear.
