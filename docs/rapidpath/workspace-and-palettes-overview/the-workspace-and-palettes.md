...
For full details on the toolbar please see [this section](/docs/rapidpath/the-toolbar/the-toolbar.md)
...
For details on how to navigate, manage and export the canvas area, click [here](/docs/rapidpath/the-canvas-area/canvas-navigation.md).
