...
Once a vehicle path has been designed as described in [Prepare swept path analysis](./prepare-swept-path-analysis), the vehicle's movement through that route can be recorded and shared as a `.gif` file.
...
Before recording, if desired, remember to [import aerial photos](/rapidplan/basemaps-and-spatial-data/integrated-maps/aerial-photo-import), so that the imagery appears in the exported animation.
...
To proceed, simply select **Save** icon, choose a file location and name, and select **Save**.
