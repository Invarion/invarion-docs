...
Term |Definition
--- | ---
Vehicle | The chosen object from the **Vehicle Library**. Can be freely placed on the plan and rotated like any other object in RapidPath. It can't be resized, its size is automatically adjusted to the scale of the current canvas.
