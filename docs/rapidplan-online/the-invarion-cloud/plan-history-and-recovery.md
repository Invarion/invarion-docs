...
To use recovery options select **History** from the plan's context menu. A new dialog will appear listing all the possible recovery points for this plan. Select the one you are interested in and choose one of two options, **Restore this version** or **Create copy**. The former restores the original plan to the selected previous version. The latter creates a new plan from information saved in the selected recovery point. Recovery points listed in the **History** dialog are divided by date.
