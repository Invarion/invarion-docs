...
Sharing plan with other RapidPlan Online subscribers will allow for a collaboration in creating the plan. To add collaborators to your plan select the **Share** option in the plan's context menu or on the plan's details panel. New dialog will appear. In the top section of the dialog enter RapidPlan Online user's email and click **Add**.
...
To create a sharable link select the **Share** option in the plan's context menu or on the plan's details panel. A new dialog will appear. In the bottom section of the dialog click the **Create share link** button. You can then copy the link and share it with anyone you want. From now on this plan will be marked as **public**. You can stop sharing at any time using **Remove share link** option in the same dialog.
