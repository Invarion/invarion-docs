...
Select an object and right-click to open a menu of additional options.
...
* **Arrange:** Move the item backward or forward in comparison to other objects on the same [layer](/rapidplan-online/rapidplan-online-workspace/layers-palette)
* **Transform:** Flip, rotate, or transform an object or group of objects
* **Add to Scratchpad:** Add the object to your [Scratchpad](/rapidplan-online/rapidplan-online-workspace/scratchpad-palette)
...
## Other context menu items for multiple-item selections
