...
**To remove the last control point placed or continue placing control points where you left off:** While the object is selected, you'll find buttons for each of these controls in the [**Context Menu**](/rapidplan-online/rapidplan-online-basics/context-menu).

For details on how objects curve or move between **control points**, see the [Geometries](./geometries) section.
