...
---
# Select and alter objects

## Selecting

Selecting objects allows you to see and make changes to that object/s' [Properties](/rapidplan-online/rapidplan-online-workspace/properties-palette), its [Context Menu](/rapidplan-online/rapidplan-online-basics/context-menu), as well as being basis by which to move and transform that object.
...
| ![control1](./assets/control1.png) | **Control Points:** [Control points](./control-points) are special handles which allow you to alter the shape of an object. Many objects and road tools have control points and allow for the insertion of multiple control points anywhere along an item. |
