...
| Print               | This option opens the Print dialog. Refer to [Print and export](/rapidplan-online/printing-and-exporting/print-and-export) for more on printing and exporting plans. |
...
| Sign out   | Selecting **Sign out** ends your session and logs you out. |
| Adjust Plan Location     | You can now adjust the location of your plan by panning the canvas or searching for a new location. You can also adjust the plan scale, if required. Once you have repositioned your plan, select 'Stop adjusting location' in the main menu or start drawing any object. |
...
| Help Center  | Opens the RapidPlan Online Help Center. |
