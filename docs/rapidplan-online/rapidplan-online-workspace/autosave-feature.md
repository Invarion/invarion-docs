...
Panning across the map or changing **plan location** will not trigger the autosave function. You must draw or place an object on the canvas to initiate autosave.
...
You will also find a link to view the history of your [saved versions](/rapidplan-online/the-invarion-cloud/plan-history-and-recovery).
