...
To add an object to your **Scratchpad**, just select the object in the canvas to bring up the context menu next to it. Then select **Add to Scratchpad** from the menu. The object will then be added to your **Scratchpad**.
