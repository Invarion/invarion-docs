...
If you need to use the application on multiple computers or with multiple users, contact [Invarion Sales](https://invarion.com/contact/) to discuss multi-machine licensing.
