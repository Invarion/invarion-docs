...
All of these parameters can be modified when editing already placed vehicles. Read more about it in [Adding Vehicle to The Plan](/docs/rapid-path/5.1 Adding Vehicle to the Plan.md) and [5.2 Editing an Existing Vehicle](/docs/rapid-path/5.2 Editing an Existing Vehicle.md).
