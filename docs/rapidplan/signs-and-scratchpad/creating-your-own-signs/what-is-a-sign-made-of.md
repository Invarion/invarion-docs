...
If you aren't familiar with these base objects and how they work, see [Basic tools](/docs/rapidplan/the-tools-palette/shape-and-line-tools/basic-tools.md). It will be considered assumed knowledge for this chapter.
