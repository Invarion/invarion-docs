...
Once it's selected, click the canvas where you would like a marker to be located. If a Location Marker is moved, by default the coordinates displayed will adjust in kind.

If you would like to place a marker at a known coordinate rather than placing it on a landmark seen on the plan, the [Dimension Input Panel](/rapidplan/drawing-snapping-and-editing/dimension-input-panel) can be used: Simply select the Location Marker tool, press **C** on your keyboard, and then type or paste your coordinates into the dialog and press **Enter**.
...
![Batch edit location markers dialog](./assets/batch%20edit%20location%20markers%20-%20batch%20edit.png)
...
### Import Mobile Road coordinates

1. Place your location markers on a plan in your chosen locations, then select them all.<br/>
Click Tools > Advanced Tools > Batch Edit Location Markers. Then click the Copy button in the middle of the dialog.
