...
Naming the fields is simple, first select the **Add** icon  and enter the appropriate values for **Label** and **Values** as shown below, then click **Save**.
...
In the **North Arrow** tab of the Properties, simply select the **Show** section to make it **True**, then adjust the direction of the arrow with the **Angle** bar as shown below.
