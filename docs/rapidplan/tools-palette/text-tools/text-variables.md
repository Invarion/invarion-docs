...
To create a new custom variable, open the **Text Variables** tool, select **+ Create a new variable** button at the top. Name your custom variable, enter the value, then press the **Save** button.
