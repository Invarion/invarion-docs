...
7. Using the **Lane Marker** tool, draw two new **lane markings** to replace the ones masked out on the southern approach. They will be drawn as type solid color yellow by default. double-click on them and change their type so that they appear as shown below.
