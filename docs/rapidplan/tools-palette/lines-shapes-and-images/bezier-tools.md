...
the wider the sweep of the curve and vice versa. To manipulate the curve handles, select **Ctrl** and one of the handles and move your mouse in any direction. Using our shape from above, the effect of the curve handles is easily seen.
