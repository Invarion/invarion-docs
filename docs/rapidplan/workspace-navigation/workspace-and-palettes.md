...
![toolbar](../workspace-and-palettes-overview/assets/toolbar-unmarked.png)

For full details on the toolbar, see [Application toolbars](./application-toolbars.md).
...
![pin unpin](../workspace-and-palettes-overview/assets/Pin_-_Unpin.png)
...
![signs](../workspace-and-palettes-overview/assets/Signs.png)

Further details can be found in [Signs palette](/docs/rapidplan/signs-and-scratchpad/signs-palette/signs-palette.md).
...
![properties options](../workspace-and-palettes-overview/assets/The_Properties_Options.png)
