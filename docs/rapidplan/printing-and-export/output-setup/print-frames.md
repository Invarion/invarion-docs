...
Print frames let you place page-space content such as titleboxes, notes, legends, and other reusable layout elements around plan output.
...
![Close_print-frames](../../the-canvas-area/assets/Close_print-frames.png)
...
Check the **Use as default print frame** box and the frame contents should appear on the Print Preview. select **Save** to close the options dialog.

![Setting_a_default_frame](../../the-canvas-area/assets/Setting_a_default_frame.png)
...
![Double_click_to_anchor.png](../../the-canvas-area/assets/Double_click_to_anchor.png)

You can also right-click on the anchor point to see the available options.

![Right_click_anchor_menu](../../the-canvas-area/assets/Right_click_anchor_menu.png)
