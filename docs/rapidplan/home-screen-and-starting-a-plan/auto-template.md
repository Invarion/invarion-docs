...
## Create a plan in Auto Template
...
- You will then be presented with your auto template on the canvas. In the top left of your canvas you will be presented with a dialog, this just confirms your widths and tapers. You can adjust them further, if required.
...
- When all the information is correct, hit **Complete** and the final template is generated on the canvas.
