...
1. Open the [New Plan Wizard](/docs/rapidplan/the-home-screen-and-starting-a-plan/new-plan-wizard.md).
...
- Use [Spatial Data Import](../importing/spatial-data-import.md) to bring in ArcGIS, CAD, KML, and Shapefile data.
- Use [Road import](../importing/road-import.md) when you specifically want road geometry from OpenStreetMap data.
