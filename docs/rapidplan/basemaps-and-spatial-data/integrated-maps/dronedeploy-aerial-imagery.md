...
4. Check DroneDeploy in the Base Maps Providers list and select **Save**.
...
![DroneDeploy setup](../assets/5-select-dronedeploy-setup.png)
...
![DroneDeploy location](../assets/6-dronedeploy-location.png)
