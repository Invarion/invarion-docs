...
## Select objects on different layers
...
**Note**: The **selection box** will only capture items that are completely surrounded by the **selection box**. However, if you hold right-click whilst dragging the **selection box** over the objects, it will select all of the objects in the **selection box**, even if partially covered.
...
![Capture2](./assets/Capture2.png) Intersecting objects (use right-click)
