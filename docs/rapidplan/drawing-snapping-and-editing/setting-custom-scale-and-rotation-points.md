...
[Resizing](./resizing-objects) and [rotating](./moving-flipping-and-rotating-objects) objects can be enhanced by changing the point they scale from or rotate around.
