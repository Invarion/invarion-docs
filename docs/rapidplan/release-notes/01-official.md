...
Custom symbols functionality has been added to selected objects, enabling greater visual consistency and customization. The following objects support the unified custom symbol system: Bike lane, North arrow, Arrow board, LUMS board, Location marker, Sign stand.
