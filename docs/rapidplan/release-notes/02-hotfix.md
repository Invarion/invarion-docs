...
* Fixed hyperlink issue on exported PDF.
...
### Version 4.4.71 (17 July 2026)
* Prevent diagonal hatches clipping during image export.
...
* Fixed issue with exporting title boxes to PDF.
...
* Fixed issue with applyng default style to Manifest/Legend.
* Fixed issue with editing object group crop.
