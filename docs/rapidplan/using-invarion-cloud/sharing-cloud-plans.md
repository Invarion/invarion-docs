...
To share a plan you will first need to open the **Plan Sharing dialog**: To do so, in the [Invarion Cloud](./organize-invarion-cloud) click the **Actions Button** (![actions button](./assets/ic-icon.png)) of a plan > click **Share**.

![plan sharing dialog](./assets/ic-plan-share.png)

## Share editing permissions with collaborators
...
**To add a Collaborating User**: Simply input the email address they have associated with their Invarion sign-in and click **Add**.

**To remove a Collaborating User**: Open the **Plan Sharing dialog** again, and click the '**X**' icon next to their email address.
...
### Create, share, and delete public plan access links

**To create a link**: Simply click **Create share link** in the **Plan Sharing dialog**.
