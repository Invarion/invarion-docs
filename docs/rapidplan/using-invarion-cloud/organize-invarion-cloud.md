...
---
# Organize Invarion Cloud

The Invarion Cloud can be opened by clicking **Browse Invarion Cloud** on the [Home screen](/rapidplan/home-screen-and-starting-a-plan/home-screen), or the button by the same name in [Application toolbars](/rapidplan/workspace-and-navigation/application-toolbars) under *File*.
...
## Manage and alter plans in Invarion Cloud
...
|**Button**|**Details**|
|-|-|
|**Rename**|Opens a dialog to rename the plan.|
...
|**Share**|Opens the [Plan Sharing Dialog Box](./sharing-cloud-plans).|
...
|**Feature**|**Details**|
|-|-|
|**Details** and **Comments** toggle|Switch between the *Details* section (discussed here), and the [comments](./commenting-on-cloud-plans) section.|
...
|**Share** button|Opens the *Sharing* dialog.|
