...
For further details on the Tools Palette see [the next page](./The%20Tools%20Palette.md).

## The Scratch Pad

The Scratch Pad is used to store objects that you commonly use to make them easily accessible.
For full details on the Scratch Pad please see [this page](./The%20Scratch%20Pad.md).
